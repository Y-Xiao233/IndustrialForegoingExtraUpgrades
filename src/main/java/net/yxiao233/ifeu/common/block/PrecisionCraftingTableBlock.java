...
public class PrecisionCraftingTableBlock extends IndustrialBlock<PrecisionCraftingTableEntity> {
    public PrecisionCraftingTableBlock() {
        super("precision_crafting_table", Properties.copy(Blocks.IRON_BLOCK).sound(SoundType.METAL).noOcclusion(), PrecisionCraftingTableEntity.class, ModItems.TAB_ADDONS);
    }

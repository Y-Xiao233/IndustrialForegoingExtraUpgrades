...
public class IFEURecipes implements IModule {
    ...
    public static DeferredHolder<RecipeType<?>,RecipeType<?>> PRECISION_SHAPELESS_TYPE;
    @Override
    public void generateFeatures(DeferredRegistryHelper helper) {
        ...
        PRECISION_SHAPELESS_SERIALIZER = helper.registerGeneric(Registries.RECIPE_SERIALIZER, "precision_shapeless", () -> new CodecRecipeSerializer<>(PrecisionShapelessRecipe.class, PRECISION_SHAPELESS_TYPE,PrecisionShapelessRecipe.CODEC));
        PRECISION_SHAPELESS_TYPE = helper.registerGeneric(Registries.RECIPE_TYPE, "precision_shapeless", () -> RecipeType.simple(ResourceLocation.fromNamespaceAndPath(IndustrialForegoingExtraUpgrades.MODID, "precision_shapeless")));
    }

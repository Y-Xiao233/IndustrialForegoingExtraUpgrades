...
public class ShapelessCategory extends AbstractJEICategory<RecipeHolder<ShapelessRecipe>> {
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<ShapelessRecipe> recipe, IFocusGroup iFocusGroup) {
        //Input
        int x = 31;
        int y = 15;
        for (int i = 0; i < 9; i++) {
    ...
    @Override
    public void draw(RecipeHolder<ShapelessRecipe> recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        //Input
        int x = 31;
        int y = 15;
        for (int i = 0; i < 9; i++) {

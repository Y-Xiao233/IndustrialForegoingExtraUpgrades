...
public class MultiBlockStructure {
    ...
    //structure
    public Pair<List<Pair<BlockPos,Block>>,List<Pair<BlockPos,TagKey<Block>>>> parseStructure(String[][] structure, Direction direction, BlockPos machinePos) {
    ...
    public boolean checkStructure(Level level, String[][] structure, Direction direction, BlockPos machinePos){
        if(!level.isClientSide()){
            Pair<List<Pair<BlockPos,Block>>,List<Pair<BlockPos,TagKey<Block>>>> poses = parseStructure(structure,direction,machinePos);

...
public abstract class IFEUItemFuelGeneratorCategory<R extends RecipeHolder<T>, T extends ItemGeneratorSerializableRecipe> extends AbstractJEICategory<R> {
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, R recipe, IFocusGroup iFocusGroup) {
        builder.addSlot(RecipeIngredientRole.INPUT,16,33).addIngredient(VanillaTypes.ITEM_STACK,recipe.value().input);
    }

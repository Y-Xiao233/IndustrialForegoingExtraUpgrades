        ...
        this.buttonAddon = (new ButtonComponent(lockPosX, lockPosY, 14, 14) {
            ...
            public List<IFactory<? extends IScreenAddon>> getScreenAddons() {
                return Collections.singletonList(() -> {
                    ...
                    ChatFormatting var10014 = ChatFormatting.GOLD;
                    var10011[0] = "" + var10014 + LangUtil.getString("tooltip.titanium.locks", new Object[0]) + ChatFormatting.WHITE + " " + LangUtil.getString("tooltip.titanium.facing_handler." + inventory.getName().toLowerCase(), new Object[0]);
                    var10004[0] = new StateButtonInfo(0, var10010, var10011);
                    var10010 = AssetTypes.BUTTON_LOCKED;
                    var10011 = new String[1];
                    var10014 = ChatFormatting.GOLD;
                    var10011[0] = "" + var10014 + LangUtil.getString("tooltip.titanium.unlocks", new Object[0]) + ChatFormatting.WHITE + " " + LangUtil.getString("tooltip.titanium.facing_handler." + inventory.getName().toLowerCase(), new Object[0]);
    ...
    private void updateFilter() {
        if (this.isLocked) {
            this.inventory.setInputFilter((stack, integer) -> {
                ...
                boolean same = ItemStack.isSameItemSameTags(this.filter[integer], stack);
